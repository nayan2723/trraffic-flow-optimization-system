...
### Constraints
```
Gi ≥ 10 s   (for each of the 4 green phases)
ΣGi ≤ 120 s (total cycle green budget)
```
Infeasible individuals are **repaired** (not penalised) before evaluation.

### Baselines
| Baseline | Description |
|----------|-------------|
| Fixed-time | Equal split: [30, 30, 30, 30] seconds |
| Single-obj GA | Standard real-coded GA minimising f₁ only |
